...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    The story should be divided into 5 parts, each part with 2 paragraphs. The word "part x" should be included in the text. The story should be engaging and have a subintended moral to it! Make some stories have a twist in the middle, others be very funny, others sentimental`;
